...
The OSV Schema maintainers take all security issues in the project
seriously. Thank you for improving the security of the OSV Schema project. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

OSV Schema leverages GitHub's private vulnerability reporting.
