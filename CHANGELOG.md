...
- 2026-09-24 Released version 1.9.1. Add Red Hat Lightwell ecosystem and `RHLW` prefix; document `Echo` ecosystem language suffixes; clarify guidance on multiple ecosystems and `GIT` entries.
